...
<jsp:useBean id="obj" class="com.Jsp.Demo.Student" scope="session"></jsp:useBean>
...
<jsp:setProperty property="rollNo" name="obj" value="10"/><br>
<jsp:setProperty property="name" name="obj" value="kavi"/><br>
